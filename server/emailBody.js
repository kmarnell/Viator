var createEmail = function(flight, itinerary) {
  var emailBody;
  var sortedItineraryKeys = Object.keys(itinerary).sort((a, b) => new Date(a) - new Date(b));
  var items = '';

  for (var i = 0; i < sortedItineraryKeys.length; i++) {
    var date = sortedItineraryKeys[i];
    items +=
    `
    <p style="color:#5b5f65; font-size:12px; text-align:left; font-family: Roboto, Verdana, Geneva, sans-serif">${date}<br />
    `;
    
    for (var j = 0; j < itinerary[date].length; j++) {
      items += 
        `
        <p style="color:#5b5f65; font-size:16px; text-align:left; font-family: Roboto, Verdana, Geneva, sans-serif"><b>${itinerary[date][j].primary}</b><br />
        <p style="color:#5b5f65; font-size:14px; text-align:left; font-family: Roboto, Verdana, Geneva, sans-serif">${itinerary[date][j].secondary}<br />
        `;
    }
                ...
                <tr>
                  <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><!-- ======= start header ======= -->
                                      ...
                                      <tbody>
                                        <tr>
                                          <td class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0">
                                              ...
                                              <tr>
                                                <td height="6" bgcolor="#3f51b5" class="contents" style="width:100%; border-top-left-radius:10px; border-top-right-radius:10px"></td>
                                              </tr>
                                            </table></td>
                                        </tr>
                                      </tbody>
                              ...
                              <![endif]-->
                                                  ...
                                                  <div class="column" style="width:100%;max-width:110px;display:inline-block;vertical-align:top;">
                                                    <table class="contents" style="border-spacing:0; width:100%"  bgcolor="#ffffff" >
                                                      <tr>
                                                        <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;" align="left"></td>
                                                      </tr>
                                                    </table>
                                                  </div>
                    ...
                    <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0" bgcolor="#FFFFFF">
                      <tr>
                        <td align="left" style="padding:0px 40px 40px 40px"><p style="color:#5b5f65; font-size:28px; text-align:left; font-family: Verdana, Geneva, sans-serif">Your Itinerary for Trip to ${flight.arrivalCity} </p>` +
    items +
                             `<!-- START BUTTON -->
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align="center"><table border="0" cellpadding="0" cellspacing="0" style="Margin:0 auto;">
                                            <tr>
                                              <td width="250" height="60" align="center" bgcolor="#3f51b5"><a href="#" style="width:250; display:block; text-decoration:none; border:0; text-align:center; font-weight:bold;font-size:18px; font-family: Arial, sans-serif; color: #ffffff; background:#3f51b5" class="button_link">Go to Your Account</a></td>
                                            </tr>
                                          </table></td>
                                      </tr>
                                    </tbody>
      ...
      <tr>
        <td><table width="100%" cellpadding="0" cellspacing="0" border="0"  bgcolor="#3f51b5">
          <tr>
            <td height="40" align="center" bgcolor="#3f51b5" class="one-column">&nbsp;</td>
          </tr>
          <tr>
            <td align="center" bgcolor="#3f51b5" class="one-column" style="padding-top:0;padding-bottom:0;padding-right:10px;padding-left:10px;"><font style="font-size:13px; text-decoration:none; color:#ffffff; font-family: Verdana, Geneva, sans-serif; text-align:center">Viator, 944 Market St, San Francisco, CA 94102</font></td>
          </tr>
          <tr>
            <td align="center" bgcolor="#3f51b5" class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;">&nbsp;</td>
          </tr>
          <tr>
            <td align="center" bgcolor="#3f51b5" class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><table width="150" border="0" cellspacing="0" cellpadding="0">
              <tr>
          ...
          <tr>
            <td align="center" bgcolor="#3f51b5" class="one-column" style="padding-top:0;padding-bottom:0;padding-right:10px;padding-left:10px;"><font style="font-size:13px; text-decoration:none; color:#ffffff; font-family: Verdana, Geneva, sans-serif; text-align:center">All rights reserved. <a href="#" target="_blank" style="color:#ffffff; text-decoration:underline">Unsubscribe from list.</a></font></td>
          </tr>
          <tr>
            <td align="center" bgcolor="#3f51b5" class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;">&nbsp;</td>
          </tr>
          <tr>
            <td height="6" bgcolor="#3f51b5" class="contents1" style="width:100%; border-bottom-left-radius:10px; border-bottom-right-radius:10px"></td>
          </tr>
          </table></td>
      </tr>
      <tr>
        <td><table width="100%" cellpadding="0" cellspacing="0" border="0"> 
          <tr>
            <td height="6" bgcolor="#3f51b5" class="contents" style="width:100%; border-bottom-left-radius:10px; border-bottom-right-radius:10px"></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
...
module.exports = {emailBody: createEmail};
